...
public class Config implements Parcelable {
    ...
    public static final int THEME_BROWN = 2;
...
//    private boolean nightMode;
    private int themeColor = R.color.red;
...
//        nightMode = in.readByte() != 0;
    ...
    public Config(int font, int fontSize, int themeMode, int themeColor,
...
//        nightMode = jsonObject.optBoolean(CONFIG_IS_NIGHT_MODE);
        themeMode = jsonObject.optInt(CONFIG_THEME);
...
public int getThemeMode() {
    ...
    public Config setThemeMode(int themeMode)
    {
        this.themeMode = themeMode;
        return this;
    }

    ...
    public static String getHtmlContent(Context context, String htmlContent, Config config) {
        ...
        switch (config.getFont()) {
            ...
            case Constants.FONT_RALEWAY:
                classes = "raleway";
                break;
            case Constants.FONT_Helvetica:
                classes = "helvetica";
                break;
            case Constants.FONT_SourceHanSansSC:
                classes = "sourceHanSansSC";
                break;
            case Constants.FONT_SourceHanSerifCN:
                classes = "sourceHanSerifCN";
                break;
            default:
                break;
        }
...
//            classes += " nightMode";
//        }
        switch (config.getThemeMode())
        {
            case Config.THEME_WHITE:

                break;
            case Config.THEME_YELLOW:
                classes += " yellowMode";
                break;
            case Config.THEME_BROWN:
                classes += " brownMode";
                break;
            case Config.THEME_BLUE:
                classes += " darkblueMode";
                break;

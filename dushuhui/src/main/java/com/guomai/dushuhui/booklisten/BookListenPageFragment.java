...
import com.guomai.dushuhui.bookshop.ShudanPageFragment;
...
public class BookListenPageFragment extends BaseBackFragment {
    public static BookListenPageFragment newInstance() {

        Bundle args = new Bundle();

        BookListenPageFragment fragment = new BookListenPageFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public static final String TAG = "BookListenPageFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*mRoot = inflater.inflate(R.layout.frag_common_recycle,
                container, false);*/
        mRoot = inflater.inflate(R.layout.frag_listenestories_chapter_page,
                container, false);
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter a, View view, int position) {
                ...
                if(view.getId() == R.id.button_play){
                    ...
                    //Toast.makeText(getActivity(), "点击听书", Toast.LENGTH_SHORT).show();
                   ...
                   if (mainFragment!=null){
                       ...
                       Toast.makeText(getActivity(), "点击听书 null", Toast.LENGTH_SHORT).show();
                   }*/
                    // BookPlayPageFragment bookPlayPageFragment = BookPlayPageFragment.newInstance();
                    //mainFragment.startBrotherFragment(bookPlayPageFragment);
                    //start(bookPlayPageFragment);
                    /*RankingPageFragment rankingPageFragment = RankingPageFragment.newInstance();
                    start(rankingPageFragment);*/
                   /* BookPlayPageFragment bookPlayPageFragment = BookPlayPageFragment.newInstance();
                    start(bookPlayPageFragment);*/
                }
            }

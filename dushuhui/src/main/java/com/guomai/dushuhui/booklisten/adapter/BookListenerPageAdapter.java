package com.guomai.dushuhui.booklisten.adapter;
...
public class BookListenerPageAdapter extends BaseQuickAdapter<TestData,BaseViewHolder> {


    public BookListenerPageAdapter(int layoutResId) {
        super(layoutResId);
    }

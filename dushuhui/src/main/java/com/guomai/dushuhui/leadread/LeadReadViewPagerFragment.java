...
public class LeadReadViewPagerFragment extends SupportFragment {
...
//    MagicIndicator magic_indicator;
    ...
    public static LeadReadViewPagerFragment newInstance() {

        Bundle args = new Bundle();

        LeadReadViewPagerFragment fragment = new LeadReadViewPagerFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_leadread_pager, container, false);
    ...
    private void initView(View view) {
        ...
        mFragments.add(LeadReadPageFragment.newInstance());

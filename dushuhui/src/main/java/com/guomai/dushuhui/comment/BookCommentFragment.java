...
public class BookCommentFragment extends BaseBackFragment {  //BaseMainFragment
    public static BookCommentFragment newInstance() {
    ...
    public static final String TAG = "BookCommentFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*mRoot = inflater.inflate(R.layout.frag_common_recycle,
                container, false);*/
        mRoot = inflater.inflate(R.layout.frag_allcomment_page,
                container, false);
...
//        mainActivity.initHeadPanel(Constant.FRAGMENT_FLAG_COMMING_SOON);
    ...
    private void initView() {
        ...
        ArrayList<CommentMultiItem> list = new ArrayList<>();
        CommentMultiItem item1 = new CommentMultiItem();
        item1.itemType = 1;
        CommentMultiItem item2 = new CommentMultiItem();
        item2.itemType = 2;
        CommentMultiItem item3 = new CommentMultiItem();
        item3.itemType = 3;
        CommentMultiItem item4 = new CommentMultiItem();
        item4.itemType = 3;
        CommentMultiItem item5 = new CommentMultiItem();
        item5.itemType = 3;
        CommentMultiItem item6 = new CommentMultiItem();
        item6.itemType = 3;
        list.add(item1);
        list.add(item2);
        list.add(item3);
        ...
        list.add(item5);
        list.add(item6);
        adapter = new BookCommentAdapter(list);
    ...
    private void setOnClickListener() {
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter a, View view, int position) {
                CommentMultiItem item = adapter.getItem(position);
                if(item.getItemType() == CommentMultiItem.COMMENT){
                    if (view.getId() == R.id.comment_list){      //评论列表
                    ...
                    }else if(view.getId() == R.id.praise){      // 点赞

...
public class ShudanPageFragment extends BaseBackFragment {
    public static ShudanPageFragment newInstance() {

        Bundle args = new Bundle();

        ShudanPageFragment fragment = new ShudanPageFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public static final String TAG = "ShudanPageFragment";
    ...
    private ShudanPageAdapter adapter;

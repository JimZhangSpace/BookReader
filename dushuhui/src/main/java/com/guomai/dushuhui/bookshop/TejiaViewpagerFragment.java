...
public class TejiaViewpagerFragment extends BaseBackFragment {
...
//    MagicIndicator magic_indicator;
    ...
    public static TejiaViewpagerFragment newInstance() {

        Bundle args = new Bundle();

        TejiaViewpagerFragment fragment = new TejiaViewpagerFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public static final String TAG = "TejiaViewpagerFragment";
    ...
    private void initView(View view) {
        tv_title.setText("特价");
        mTitleDataList.add("特价");
        mTitleDataList.add("免费");

        mFragments.add(TejiaPageFragment.newInstance());     ////
...
//                pop();
                MainFragment fragment = (MainFragment) getParentFragment().getParentFragment().getParentFragment().getParentFragment();
                fragment.popChild();
            }
        });
